...
--
-- Temporary view structure for view `canthuevos`
--

DROP TABLE IF EXISTS `canthuevos`;
/*!50001 DROP VIEW IF EXISTS `canthuevos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `canthuevos` AS SELECT 
 1 AS `tipo_pico`,
 1 AS `id`,
 1 AS `descripcion`,
 1 AS `nombre_especie`,
...
--
-- Temporary view structure for view `colores`
--

DROP TABLE IF EXISTS `colores`;
/*!50001 DROP VIEW IF EXISTS `colores`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `colores` AS SELECT 
 1 AS `color`,
 1 AS `id`,
 1 AS `descripcion`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `correos`
--

DROP TABLE IF EXISTS `correos`;
/*!50001 DROP VIEW IF EXISTS `correos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `correos` AS SELECT 
 1 AS `id`,
 1 AS `id_persona`,
 1 AS `correo`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `especies`
--

DROP TABLE IF EXISTS `especies`;
/*!50001 DROP VIEW IF EXISTS `especies`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `especies` AS SELECT 
 1 AS `especie`,
 1 AS `id`,
 1 AS `descripcion`,
 1 AS `nombre_genero`,
...
--
-- Temporary view structure for view `familias`
--

DROP TABLE IF EXISTS `familias`;
/*!50001 DROP VIEW IF EXISTS `familias`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `familias` AS SELECT 
 1 AS `familia`,
 1 AS `id`,
 1 AS `descripcion`,
 1 AS `nombre_suborden`,
 1 AS `id_suborden`*/;
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Tabla donde se guardan las imagenes de cada usuario.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fotografia` VALUES (1,'pajaro 1.jpg',NULL,'image/jpeg',NULL,'Pajaros/1433653266pajaro 1.jpg','2015-06-06','root@localhost',NULL,NULL,1),(2,'pajaro 3.jpg',NULL,'image/jpeg',NULL,'Pajaros/1433653280pajaro 3.jpg','2015-06-06','root@localhost',NULL,NULL,3),(3,'pajaro 6.jpg',NULL,'image/jpeg',NULL,'Pajaros/1433653293pajaro 6.jpg','2015-06-06','root@localhost',NULL,NULL,7),(4,'pajaro 8.jpg',NULL,'image/jpeg',NULL,'Pajaros/1433653311pajaro 8.jpg','2015-06-06','root@localhost',NULL,NULL,4),(5,'pajaro 10.jpg',NULL,'image/jpeg',NULL,'Pajaros/1433653323pajaro 10.jpg','2015-06-06','root@localhost',NULL,NULL,9),(6,'pajaro 13.jpg',NULL,'image/jpeg',NULL,'Pajaros/1433653342pajaro 13.jpg','2015-06-06','root@localhost',NULL,NULL,8);
...
--
-- Temporary view structure for view `fotos`
--

DROP TABLE IF EXISTS `fotos`;
/*!50001 DROP VIEW IF EXISTS `fotos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `fotos` AS SELECT 
 1 AS `id`,
 1 AS `nombre_foto`,
 1 AS `url`,
 1 AS `id_pajaroxpersona`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `generos`
--

DROP TABLE IF EXISTS `generos`;
/*!50001 DROP VIEW IF EXISTS `generos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `generos` AS SELECT 
 1 AS `genero`,
 1 AS `id`,
 1 AS `descripcion`,
 1 AS `nombre_familia`,
...
--
-- Temporary view structure for view `ordenes`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='Tabla donde se guardan los datos de las aves que ha visto cada persona.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary view structure for view `pajarosxpersona`
--

DROP TABLE IF EXISTS `pajarosxpersona`;
/*!50001 DROP VIEW IF EXISTS `pajarosxpersona`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `pajarosxpersona` AS SELECT 
 1 AS `id`,
 1 AS `id_persona`,
 1 AS `especie`,
 1 AS `cedula`,
...
--
-- Temporary view structure for view `subordenes`
--

DROP TABLE IF EXISTS `subordenes`;
/*!50001 DROP VIEW IF EXISTS `subordenes`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `subordenes` AS SELECT 
 1 AS `suborden`,
 1 AS `id`,
 1 AS `descripcion`,
 1 AS `nombre_orden`,
...
--
-- Temporary view structure for view `telefonos`
--

DROP TABLE IF EXISTS `telefonos`;
/*!50001 DROP VIEW IF EXISTS `telefonos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `telefonos` AS SELECT 
 1 AS `id`,
 1 AS `id_persona`,
 1 AS `telefono`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `tiposdepicos`
--

DROP TABLE IF EXISTS `tiposdepicos`;
/*!50001 DROP VIEW IF EXISTS `tiposdepicos`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `tiposdepicos` AS SELECT 
 1 AS `tipo_pico`,
 1 AS `id`,
 1 AS `descripcion`,
 1 AS `nombre_especie`,
...
--
-- Temporary view structure for view `zonasvida`
--

DROP TABLE IF EXISTS `zonasvida`;
/*!50001 DROP VIEW IF EXISTS `zonasvida`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `zonasvida` AS SELECT 
 1 AS `tipo_pico`,
 1 AS `id`,
 1 AS `descripcion`*/;
SET character_set_client = @saved_cs_client;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `CONSULTAS_AVES` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `CONSULTA_AVES_POR_PERSONA` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getallFamilia` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getallGenero` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getallOrden` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getallOrden`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getallPico` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getallSuborden` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getFotos` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getFotos`(in pUsuario varchar(50))
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getTipoPico`(in pEspecie varchar(50))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `setContrasenia` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `setContrasenia`(in pViejaContrasenia varchar(45),in pNuevaContrasenia varchar(45),in pUsuario varchar(45))
BEGIN
...
--
-- Final view structure for view `canthuevos`
--
...
/*!50001 VIEW `canthuevos` AS select `cantidad_huevos`.`Cantidad` AS `tipo_pico`,`cantidad_huevos`.`idcantidad_Huevos` AS `id`,NULL AS `descripcion`,NULL AS `nombre_especie`,NULL AS `id_especie` from `cantidad_huevos` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `colores`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `colores` AS select `color`.`Color` AS `color`,`color`.`idColor` AS `id`,NULL AS `descripcion` from `color` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `correos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `correos` AS select NULL AS `id`,`correo`.`Persona_idPersona` AS `id_persona`,`correo`.`Correo` AS `correo` from `correo` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `especies`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `especies` AS select `especie`.`Especie` AS `especie`,`genero`.`idGenero` AS `id`,NULL AS `descripcion`,`genero`.`Genero` AS `nombre_genero`,`genero`.`idGenero` AS `id_genero` from (`especie` join `genero`) where (`especie`.`Genero_idGenero` = `genero`.`idGenero`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `familias`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `familias` AS select `familia`.`Familia` AS `familia`,`familia`.`idFamilia` AS `id`,NULL AS `descripcion`,`suborden`.`Suborden` AS `nombre_suborden`,`suborden`.`idSuborden` AS `id_suborden` from (`familia` join `suborden`) where (`familia`.`Suborden_idSuborden` = `suborden`.`idSuborden`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `fotos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `fotos` AS select `fotografia`.`idFotografia` AS `id`,`fotografia`.`nombre` AS `nombre_foto`,`fotografia`.`URL` AS `url`,`fotografia`.`Pajaros_X_Persona_Pajaros_X_Persona_id` AS `id_pajaroxpersona` from `fotografia` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `generos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `generos` AS select `genero`.`Genero` AS `genero`,`genero`.`idGenero` AS `id`,NULL AS `descripcion`,`familia`.`Familia` AS `nombre_familia`,`familia`.`idFamilia` AS `id_familia` from (`genero` join `familia`) where (`genero`.`Familia_idFamilia` = `familia`.`idFamilia`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `ordenes` AS select `orden`.`Orden` AS `orden`,`orden`.`idOrden` AS `id`,NULL AS `descripcion`,`orden`.`Clase_idClase` AS `id_clase` from (`orden` join `clase`) where (`orden`.`Clase_idClase` = `clase`.`idClase`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `pajarosxpersona`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pajarosxpersona` AS select `pajaros_x_persona`.`Pajaros_X_Persona_id` AS `id`,`persona`.`idPersona` AS `id_persona`,`especie`.`Especie` AS `especie`,`persona`.`idPersona` AS `cedula`,`pajaros_x_persona`.`Color_idColor` AS `id_color`,`zona_de_vida`.`Zona_de_Vida` AS `zona_vida` from (((`pajaros_x_persona` join `persona` on((`pajaros_x_persona`.`Persona_idPersona` = `persona`.`Usuario_idUsuario`))) join `especie` on((`pajaros_x_persona`.`Especie_idEspecie` = `especie`.`idEspecie`))) join `zona_de_vida` on((`pajaros_x_persona`.`Zona_de_Vida_idZonadeVida` = `zona_de_vida`.`idZona_de_Vida`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `personas` AS select `persona`.`idPersona` AS `id`,`persona`.`Nombre` AS `nombre`,`persona`.`Apellido` AS `primer_apellido`,NULL AS `segundo_apellido`,`persona`.`idPersona` AS `cedula` from `persona` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `subordenes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `subordenes` AS select `suborden`.`Suborden` AS `suborden`,`suborden`.`idSuborden` AS `id`,NULL AS `descripcion`,`orden`.`Orden` AS `nombre_orden`,`orden`.`idOrden` AS `id_orden` from (`suborden` join `orden`) where (`suborden`.`Orden_idOrden` = `orden`.`idOrden`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `telefonos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `telefonos` AS select NULL AS `id`,`telefono`.`Persona_idPersona` AS `id_persona`,`telefono`.`Telefono` AS `telefono` from `telefono` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `tiposdepicos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `tiposdepicos` AS select `tipo_de_pico`.`Tipo_de_Pico` AS `tipo_pico`,`tipo_de_pico`.`idTipo_de_Pico` AS `id`,NULL AS `descripcion`,`especie`.`Especie` AS `nombre_especie`,`especie`.`idEspecie` AS `id_especie` from (`tipo_de_pico` join `especie`) where (`tipo_de_pico`.`Especie_idEspecie` = `especie`.`idEspecie`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `usuarios` AS select `usuario`.`idUsuario` AS `id`,`usuario`.`NomUsuario` AS `nickname`,'1234' AS `password`,`persona`.`idPersona` AS `cedula`,`persona`.`idPersona` AS `id_persona`,`tipo_de_persona`.`Tipo_de_Persona` AS `tipo_usuario` from ((`usuario` join `persona` on((`usuario`.`idUsuario` = `persona`.`Usuario_idUsuario`))) join `tipo_de_persona` on((`persona`.`Tipo_de_Persona_idTipo_de_Persona` = `tipo_de_persona`.`idTipo_de_Persona`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `zonasvida`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `zonasvida` AS select `zona_de_vida`.`Zona_de_Vida` AS `tipo_pico`,`zona_de_vida`.`idZona_de_Vida` AS `id`,NULL AS `descripcion` from `zona_de_vida` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2015-06-07 22:02:10
