CREATE DATABASE  IF NOT EXISTS `proyecto2web` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `proyecto2web`;
-- MySQL dump 10.13  Distrib 5.6.23, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: proyecto2web
-- ------------------------------------------------------
...
--
/*!50003 DROP PROCEDURE IF EXISTS `addPajaro` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `addPajaro`(IN idEspecie int, IN nombre_comun varchar(50), IN nombre_ingles varchar(50), 
...
-- Dump completed on 2015-05-24 21:12:17
